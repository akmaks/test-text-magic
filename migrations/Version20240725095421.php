...
final class Version20240725095421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id UUID NOT NULL, test_case_id UUID DEFAULT NULL, text TEXT NOT NULL, is_right BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_DADD4A251351003D ON answer (test_case_id)');
